1.	File: PrintCurrency.java
   	Usage: java PrintCurrency XXX(ISO CODE)

2. 	File: MutableString.java TestMutString.java
...
5.	File: NRCompute.java
	Usage: java NRCompute <co_1> <co_2> <co_3>...
